...
public class TwoStringacceptandreturn {
...
begins with the second String. Return false if it does not.Overload the method to accept a two Strings and a number
