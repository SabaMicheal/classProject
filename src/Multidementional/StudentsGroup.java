...
//Create a program that will ask the user to enter how many
// groups they have. Then ask the user to enter how many students
// are in each group. Allow the user to enter each name of the people
// in each group.Print the 2D array of all the groups at the end